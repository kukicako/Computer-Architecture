...
#FLAGS 4 CMP LESS THAN /GREATER THAN/ EQQUAL TOO
LT = 0b00000100
GT = 0b00000010
EQ = 0b00000001
...
class CPU:
    ...
    def op_call(self, operand_a, operand_b):
        # Pushes next instruction to stack
        self.push_val(self.pc + 2)
        # sets pc to address the subroutine
        self.pc = self.reg[operand_a]

    def op_ret(self, operand_a, operand_b):
        # poping next instruction of top of stack
    ...
    def ram_read(self, mar):
        #accept addres to (mar) and return
        #adress to write
        #mar = memory adress register/ mdr = memory data register
        mdr = self.ram[mar]
        return mdr
